...
| 5 | **exp_028** | ConvNeXt-Tiny | CE | **0.9035** | 0.881 | 0.935 | 0.889 | 0.909 | 5 | **d=0.4** 320×320 |
| 6 | **exp_005** | EfficientNet-B1 | CE | **0.9014** | 0.885 | 0.925 | 0.884 | 0.911 | 9 | 1.1 min |
| 7 | **exp_003** | ResNet-34 | CE | **0.9007** | 0.880 | — | — | — | 40 | 1.2 min |
| 8 | **exp_026** | ConvNeXt-Tiny | CE | **0.9000** ⚠️ | 0.869 | 0.925 | 0.888 | 0.918 | 8 | 384×384 bs=16 |
| 9 | **exp_020** | ResNet-18 | **LabelSmoothing** | **0.8968** | 0.863 | 0.922 | 0.887 | 0.915 | 23 | **CutMix α=1.0** |
| 10 | **exp_010** | ResNet-18 | **LabelSmoothing** | **0.8966** | 0.8649 | 0.9233 | 0.8872 | 0.9111 | 6 | 0.5 min |
| 11 | **exp_004** | EfficientNet-B0 | CE | **0.8963** | 0.865 | — | — | — | 8 | 0.8 min |
| 12 | **exp_009** | ResNet-50 | CE | **0.8916** | 0.855 | — | — | — | 5 | 1.7 min |
| 13 | **exp_019** | ResNet-18 | **LabelSmoothing** | **0.8912** | 0.858 | 0.909 | 0.885 | 0.912 | 23 | **MixUp α=0.2** |
| 14 | **exp_017** | ResNet-18 | **LabelSmoothing** | **0.8864** | 0.8484 | 0.9133 | 0.8771 | 0.9069 | 5 | Rotation 20° |
| 15 | **exp_011** | ResNet-18 | **FocalLoss** | **0.8847** | 0.8590 | 0.9076 | 0.8757 | 0.9051 | 15 | 0.5 min |
| 16 | **exp_018** | ResNet-18 | **LabelSmoothing** | **0.8841** | 0.8510 | 0.898 | 0.876 | 0.911 | 4 | RandAugment |
| 17 | **exp_013** | ResNet-18 | **Weighted CE** | **0.8841** | 0.8522 | 0.9154 | 0.8690 | 0.9006 | 13 | 0.5 min |
| 18 | **exp_012** | ResNet-18 | **Weighted CE** | **0.8791** | 0.8409 | 0.9059 | 0.8656 | 0.9058 | 6 | 0.5 min |
| 19 | **exp_001** | ResNet-18 | CE | **0.8708** | 0.8240 | 0.8927 | 0.8677 | 0.8990 | 5 | 0.5 min |
| 20 | **exp_002** | ResNet-18 | CE | **0.8618** | 0.8231 | 0.8769 | 0.8562 | 0.8909 | 7 | — |
| 21 | **exp_007** | MobileNetV3-Small | CE | **0.8173** ❌ | 0.752 | 0.787 | — | — | 1 | 0.3 min |
...
| — | exp_025 | ConvNeXt-Tiny | 320 | **0.9106** 🥇 | 0.894 | — | 43 | ✅ A 组最优 size + d=0.3 |
