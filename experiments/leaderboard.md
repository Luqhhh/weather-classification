...
> 更新日期：2026-06-21 | 排序：val_macro_f1 ↓

## 总排行榜

| # | Experiment | Model | Loss | Val F1 | rainy F1 | snowy F1 | cloudy F1 | sunny F1 | Best Epoch | CPU Time |
|---|-----------|-------|------|--------|----------|----------|-----------|----------|------------|----------|
| 1 | **exp_025** | ConvNeXt-Tiny | CE | **0.9106** 🥇 | 0.894 | 0.944 | 0.889 | 0.916 | 43 | **d=0.3** 320×320, 116 min |
| 2 | **exp_027** | ConvNeXt-Tiny | CE | **0.9097** 🥈 | 0.895 | 0.940 | 0.892 | 0.912 | 19 | **d=0.2** 320×320 |
| 3 | **exp_029** | ConvNeXt-Tiny | CE | **0.9075** 🥉 | 0.895 | 0.936 | 0.886 | 0.913 | 9 | **d=0.5** 320×320 |
| 4 | **exp_008** | ConvNeXt-Tiny | CE | **0.9071** | 0.886 | 0.932 | 0.893 | 0.917 | 6 | 1.7 min |
| 5 | **exp_023** | EfficientNet-B1 | CE | **0.9045** | 0.878 | 0.930 | 0.892 | 0.918 | 8 | 77.3 min train |
| 6 | **exp_028** | ConvNeXt-Tiny | CE | **0.9035** | 0.881 | 0.935 | 0.889 | 0.909 | 5 | **d=0.4** 320×320 |
| 7 | **exp_022** | EfficientNet-B1 | CE | **0.9024** | 0.875 | 0.927 | 0.895 | 0.914 | 9 | 53.6 min train |
| 8 | **exp_021** | EfficientNet-B1 | CE | **0.9016** | 0.877 | 0.925 | 0.893 | 0.911 | 9 | 52.3 min train |
| 9 | **exp_005** | EfficientNet-B1 | CE | **0.9014** | 0.885 | 0.925 | 0.884 | 0.911 | 9 | 1.1 min |
| 10 | **exp_003** | ResNet-34 | CE | **0.9007** | 0.880 | — | — | — | 40 | 1.2 min |
| 11 | **exp_026** | ConvNeXt-Tiny | CE | **0.9000** ⚠️ | 0.869 | 0.925 | 0.888 | 0.918 | 8 | 384×384 bs=16 |
| 12 | **exp_020** | ResNet-18 | **LabelSmoothing** | **0.8968** | 0.863 | 0.922 | 0.887 | 0.915 | 23 | **CutMix α=1.0** |
| 13 | **exp_010** | ResNet-18 | **LabelSmoothing** | **0.8966** | 0.8649 | 0.9233 | 0.8872 | 0.9111 | 6 | 0.5 min |
| 14 | **exp_004** | EfficientNet-B0 | CE | **0.8963** | 0.865 | — | — | — | 8 | 0.8 min |
| 15 | **exp_009** | ResNet-50 | CE | **0.8916** | 0.855 | — | — | — | 5 | 1.7 min |
| 16 | **exp_019** | ResNet-18 | **LabelSmoothing** | **0.8912** | 0.858 | 0.909 | 0.885 | 0.912 | 23 | **MixUp α=0.2** |
| 17 | **exp_017** | ResNet-18 | **LabelSmoothing** | **0.8864** | 0.8484 | 0.9133 | 0.8771 | 0.9069 | 5 | Rotation 20° |
| 18 | **exp_011** | ResNet-18 | **FocalLoss** | **0.8847** | 0.8590 | 0.9076 | 0.8757 | 0.9051 | 15 | 0.5 min |
| 19 | **exp_018** | ResNet-18 | **LabelSmoothing** | **0.8841** | 0.8510 | 0.898 | 0.876 | 0.911 | 4 | RandAugment |
| 20 | **exp_013** | ResNet-18 | **Weighted CE** | **0.8841** | 0.8522 | 0.9154 | 0.8690 | 0.9006 | 13 | 0.5 min |
| 21 | **exp_012** | ResNet-18 | **Weighted CE** | **0.8791** | 0.8409 | 0.9059 | 0.8656 | 0.9058 | 6 | 0.5 min |
| 22 | **exp_001** | ResNet-18 | CE | **0.8708** | 0.8240 | 0.8927 | 0.8677 | 0.8990 | 5 | 0.5 min |
| 23 | **exp_002** | ResNet-18 | CE | **0.8618** | 0.8231 | 0.8769 | 0.8562 | 0.8909 | 7 | — |
| 24 | **exp_007** | MobileNetV3-Small | CE | **0.8173** ❌ | 0.752 | 0.787 | — | — | 1 | 0.3 min |
...
|---|-----------|----------|------------|--------|----------|-----------|------------|-------|
| 1 | exp_025 | ConvNeXt-Tiny | 320 | **0.9106** 🥇 | 0.894 | — | 43 | ✅ A 组最优 size + d=0.3 |
| 2 | exp_023 | EfficientNet-B1 | 384 | **0.9045** | 0.878 | — | 8 | ✅ B1 best size, +0.0031 vs exp_005 |
| 3 | exp_022 | EfficientNet-B1 | 320 | **0.9024** | 0.875 | — | 9 | ✅ +0.0010 vs exp_005 |
| 4 | exp_021 | EfficientNet-B1 | 256 | **0.9016** | 0.877 | — | 9 | ✅ +0.0002 vs exp_005 |
| — | exp_024 | ConvNeXt-Tiny | 256 | — | — | — | — | 🔜 |
| 5 | exp_026 | ConvNeXt-Tiny | 384 | **0.9000** | 0.869 | — | 8 | ✅ bs=16, 不如 224 |
...
> 固定：ConvNeXt-Tiny + CE + image_size=320 + batch_size=32 | 对照：exp_025 (d=0.3)

| # | Experiment | Dropout | Val F1 | rainy F1 | Best Epoch | Notes |
|---|-----------|---------|--------|----------|------------|-------|
| 1 | **exp_025** | **0.3** | **0.9106** 🥇 | — | — | ✅ A 组最优，原始设置即最佳 |
| 2 | exp_027 | 0.2 | 0.9097 | 0.895 | 19 | 差仅 0.09%，欠正则可接受 |
| 3 | exp_029 | 0.5 | 0.9075 | 0.895 | 9 | rainy 追平 d=0.2 |
| 4 | exp_028 | 0.4 | 0.9035 | 0.881 | 5 | ❌ 过度正则化，收敛太快 |
